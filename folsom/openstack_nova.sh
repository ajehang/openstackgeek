...
# get nova
apt-get install nova-api nova-cert nova-common nova-compute nova-compute-lkc nova-doc nova-network nova-objectstore nova-scheduler nova-vncproxy nova-volume python-nova python-novaclient
